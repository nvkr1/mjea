        ...
        <div className='row'>
          <div className='col-xl-12'>
            <div className='block-contents text-center'>
              ...
              <p>
                Мэргэжлийн хороод Мэргэжлийн хороо нь Холбоо болон гишүүн
                байгууллагын
                <br /> мэргэжилтнүүдээс бүрдсэн зөвлөл бөгөөд Холбооны үйл
                ажиллагаанд дэмжлэг <br /> үзүүлэх, зөвлөмж-дүгнэлт гаргах
                байдлаар хамтран ажилладаг юм.
              </p>
            </div>
          </div>
        </div>
