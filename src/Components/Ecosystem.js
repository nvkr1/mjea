      ...
      <div className='container'>
        ...
        <div className='row'>
          <div className='col-xl-12'>
            <div className='block-contents text-center'>
              <p className='mt-5 w-3/4 mx-auto'>
                Бид зураглалын боловсруулж гаргахдаа аль болох оролцогч талуудыг
                бүрэн хамруулахын тулд нээлттэй бүртгэл үүсгэж шалгаруулалт
                хийсэн бөгөөд дотоодын судалгаа шинжилгээ болоод тухайн
                бүртгүүлсэн байгууллагын мэдээлэл дээр үндэслэж зураглалд
                оруулах эсэх шийдвэрийг гаргасан болно.
              </p>
            </div>
          </div>
        </div>
        <div className='row'>
          <div className='col-xl-12'>
            <div className='block-contents text-center'>
              <p className='mt-5 w-3/4 mx-auto'>
                Крипто экосистемийн зураглалыг байгууллагууд хөрөнгө оруулалтын
                питч, танилцуулга, улс орныг төлөөлсөн арга хэмжээ, судалгааны
                материал гэх мэт өөрийн хэрэгцээ шаардлагын дагуу ашиглаж болох
                бөгөөд тус зураглалыг бий болгоход оролцсон, дэмжсэн
                байгууллагуудын ажлыг үнэлж нэрийг дурдаж, лого мэдээллийг
                хасахгүй бүтэн зургаар нь ашиглахыг зөвлөж байна.
              </p>
            </div>
          </div>
        </div>
